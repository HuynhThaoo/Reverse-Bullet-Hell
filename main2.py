...
class Game:
    ...
    def increase_difficulty(self):
        ...
        for sprite in self.enemy_sprites:
            if sprite.enemy_type == 'fast':
                sprite.speed = min(300, sprite.speed + 5)  # Giảm từ +10 xuống +5
    ...
    def auto_shoot(self):
        ...
        if current_time - self.auto_shoot_timer >= self.auto_shoot_interval and self.can_shoot:
            ...
            # Chỉnh sửa logic để bắn ra 1 viên đạn
            angles = [0]  # Chỉ bắn 1 viên đạn
            for angle in angles:
    ...
    def display_item_effect(self, item_type):
        ...
        messages = {
            ...
            'extra_score': 'Score +2!',  # Cập nhật thông báo
                    ...
                    if self.effect_timers['bullet_pierce']['active']:
                        for sprite in collision_sprites:
                            ...
                            if sprite.health <= 0:
                                ...
                                if random.random() < 0.25:
                                    ...
                                    weights = [0.15, 0.10, 0.10, 0.05, 0.10, 0.10, 0.10, 0.10, 0.05, 0.05, 0.05, 0.15]  # extra_score: 0.10 → 0.05
                        ...
                        if sprite.health <= 0:
                            ...
                            if random.random() < 0.35:
                                item_types = ['health', 'shoot_speed', 'move_speed', 'clear_enemies', 'pass_through', 'double_damage', 'shield', 'bullet_spread', 'freeze_enemies', 'extra_score', 'bullet_pierce', 'health_regen']
                                weights = [0.15, 0.10, 0.10, 0.05, 0.10, 0.10, 0.10, 0.10, 0.05, 0.05, 0.05, 0.15]
                                item_type = random.choices(item_types, weights=weights, k=1)[0]
                                Item(sprite.rect.center, (self.all_sprites, self.item_sprites), item_type)
    ...
    def item_collision(self):
        ...
        for item in collided_items:
            if item.item_type == 'health':
                ...
                self.hit_count += 2  # Giảm từ +3 xuống +2
                    ...
                    if effect == 'shoot_speed':
                        ...
                        for sprite in self.enemy_sprites:
                            ...
                            sprite.speed = min(
                                ...
                                sprite.speed + (self.hit_count // 10) * 5  # Đồng bộ với increase_difficulty
                            )
